...
emails = [
  {
    ...
    received_at: Date.current.beginning_of_day + 10.hours,
    read: false,
    starred: true,
  ...
  },
  {
    ...
    received_at: Date.parse("2025-05-16T22:45:00"),
    read: true,
    starred: false,
    labels: ["social"]
  },
  {
    ...
    received_at: Date.parse("2025-05-16T11:20:00"),
    read: false,
    starred: true,
    labels: ["important"]
  },
  {
    ...
    received_at: Date.parse("2025-05-15T16:35:00"),
    read: false,
    starred: false,
    labels: ["shopping"]
  },
  {
    ...
    received_at: Date.parse("2025-05-15T14:22:00"),
    read: true,
    starred: false,
    labels: ["security"]
  },
  {
    ...
    received_at: Date.parse("2025-05-15T09:15:00"),
    read: false,
    starred: false,
    labels: ["work"]
  },
  {
    ...
    received_at: Date.parse("2025-05-14T08:30:00"),
    read: true,
    starred: true,
    labels: ["work", "meeting"]
  },
  {
    ...
    received_at: Date.parse("2025-05-14T06:00:00"),
    read: false,
    starred: false,
    labels: ["billing"]
  },
  {
    ...
    received_at: Date.parse("2025-05-13T12:00:00"),
    read: true,
    starred: false,
    labels: ["development"]
  },
  {
    ...
    received_at: Date.parse("2025-05-13T15:45:00"),
    read: false,
    starred: true,
  ...
  },
  {
    ...
    received_at: Date.parse("2025-05-12T18:30:00"),
    read: true,
    starred: true,
  ...
  },
  {
    ...
    received_at: Date.parse("2025-05-12T10:15:00"),
    read: false,
    starred: false,
    labels: ["hr", "company"]
  },
  {
    ...
    received_at: Date.parse("2025-05-11T16:20:00"),
    read: true,
    starred: false,
    labels: ["design", "tools"]
  },
  {
    ...
    received_at: Date.parse("2025-05-11T13:42:00"),
    read: false,
    starred: true,
    labels: ["community"]
  },
  {
    ...
    received_at: Date.current.beginning_of_day + 9.hours + 30.minutes,
    read: false,
    starred: true,
